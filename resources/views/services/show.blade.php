            ...
            <div class="container">
                ...
                <div class="service-projects-grid">
                    @foreach ($projects as $project)
                        <div class="service-project-card" data-aos="fade-up" data-aos-delay="{{ $loop->iteration * 100 }}" style="cursor: pointer;" onclick="window.location.href='{{ route('projects.show', $project->slug) }}'">
                            <div class="project-card-image-box">
                                <img src="{{ asset($project->image) }}" alt="{{ $project->title }}">
                                <div class="project-card-hover-overlay">
                                    <a href="{{ route('projects.show', $project->slug) }}" class="project-card-btn">
