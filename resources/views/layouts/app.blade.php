...
<body>
    ...
    <footer class="site-footer">
        <div class="container">
            ...
            <div class="footer-top-grid">
                ...
                <div class="footer-col footer-col-brand">
                    ...
                    <p class="footer-brand-desc">
                        {{ $site['about_text'] ?? 'Solfa Technologies delivers reliable technology services and expert digital growth support to help businesses scale.' }}
                    </p>
                    <div class="footer-social-circles">
                        <a href="{{ $site['facebook'] ?? 'https://facebook.com' }}" target="_blank" rel="noopener" aria-label="Facebook" class="social-circle-btn" title="Facebook">
                        ...
                        <a href="{{ $site['linkedin'] ?? 'https://linkedin.com' }}" target="_blank" rel="noopener" aria-label="LinkedIn" class="social-circle-btn" title="LinkedIn">
                        ...
                        <a href="{{ $site['instagram'] ?? 'https://instagram.com' }}" target="_blank" rel="noopener" aria-label="Instagram" class="social-circle-btn" title="Instagram">
                        ...
                        <a href="{{ $site['twitter'] ?? 'https://x.com' }}" target="_blank" rel="noopener" aria-label="X (Twitter)" class="social-circle-btn" title="X (Twitter)">
                            <svg width="14" height="14" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                        </a>
                        <a href="{{ $site['tiktok'] ?? 'https://tiktok.com' }}" target="_blank" rel="noopener" aria-label="TikTok" class="social-circle-btn" title="TikTok">
                            <svg width="15" height="15" fill="currentColor" viewBox="0 0 24 24"><path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64c.29 0 .56.04.82.1v-3.5a6.37 6.37 0 0 0-1-.08A6.38 6.38 0 0 0 3 15.6a6.37 6.37 0 0 0 10.86 4.5 6.33 6.33 0 0 0 1.94-4.57V8.77a8.23 8.23 0 0 0 4.79 1.48v-3.5a4.84 4.84 0 0 1-1-.06z"/></svg>
                        </a>
                    </div>
                </div>
                ...
                <div class="footer-col">
                    <h3 class="footer-col-title">Service</h3>
                    <ul class="footer-link-list">
                        <li><a href="{{ route('services.show', 'web-development') }}"><span class="link-chevron">&rsaquo;</span> Website Development</a></li>
                        <li><a href="{{ route('services.show', 'digital-marketing') }}"><span class="link-chevron">&rsaquo;</span> Digital Marketing</a></li>
                        <li><a href="{{ route('services.show', 'web-development') }}"><span class="link-chevron">&rsaquo;</span> WordPress Development</a></li>
                        <li><a href="{{ route('services.show', 'graphics-design') }}"><span class="link-chevron">&rsaquo;</span> Graphic Design</a></li>
                        <li><a href="{{ route('services.show', 'graphics-design') }}"><span class="link-chevron">&rsaquo;</span> Brand Identity</a></li>
                    </ul>
                </div>

                {{-- Column 3: Quick Link --}}
                <div class="footer-col">
                    <h3 class="footer-col-title">Quick Link</h3>
                    <ul class="footer-link-list">
                        <li><a href="{{ route('about') }}"><span class="link-chevron">&rsaquo;</span> About Us</a></li>
                        <li><a href="{{ route('services.index') }}"><span class="link-chevron">&rsaquo;</span> Portfolio</a></li>
                        <li><a href="{{ route('about') }}"><span class="link-chevron">&rsaquo;</span> Our Team</a></li>
                        <li><a href="{{ route('careers.index') }}"><span class="link-chevron">&rsaquo;</span> Careers <span class="hiring-badge">We're hiring!</span></a></li>
                    </ul>
                </div>
                ...
                <div class="footer-col">
                    ...
                    <ul class="footer-contact-list">
                        <li>
                            <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
                            <a href="mailto:{{ $site['email'] ?? 'info@solfatechnologies.com' }}">{{ $site['email'] ?? 'info@solfatechnologies.com' }}</a>
                        </li>
                        <li>
                            <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path></svg>
                            <a href="tel:{{ preg_replace('/\s+/', '', $site['phone'] ?? '+15559876543') }}">{{ $site['phone'] ?? '+1 (555) 987-6543' }}</a>
                        </li>
                        <li>
                            <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path><circle cx="12" cy="10" r="3"></circle></svg>
                            <span>{{ $site['address'] ?? '789 Oak St, Smalltown United State 23456' }}</span>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            {{-- Bottom Expanded Directory Section: 4 Columns --}}
            <div class="footer-directory-grid">
                {{-- Column 1: Paid Advertising --}}
                <div class="directory-col">
                    <h4 class="directory-col-title">Paid Advertising</h4>
                    <ul class="directory-link-list">
                        <li><a href="{{ route('services.show', 'digital-marketing') }}">Google Ads (SEM)</a></li>
                        <li><a href="{{ route('services.show', 'digital-marketing') }}">Facebook Ads Agency</a></li>
                        <li><a href="{{ route('services.show', 'digital-marketing') }}">PPC (Pay-per-click)</a></li>
                        <li><a href="{{ route('services.show', 'digital-marketing') }}">LinkedIn Ads</a></li>
                        <li><a href="{{ route('services.show', 'digital-marketing') }}">Paid Social Media Agency</a></li>
                        <li><a href="{{ route('services.show', 'digital-marketing') }}">Adwords Agency</a></li>
                        <li><a href="{{ route('services.show', 'digital-marketing') }}">Spotify Ads</a></li>
                        <li><a href="{{ route('services.show', 'digital-marketing') }}">Hulu Ads</a></li>
                        <li><a href="{{ route('services.show', 'digital-marketing') }}">Amazon Ads</a></li>
                    </ul>
                </div>

                {{-- Column 2: SEO & Content Marketing --}}
                <div class="directory-col">
                    <h4 class="directory-col-title">SEO & Content Marketing</h4>
                    <ul class="directory-link-list">
                        <li><a href="{{ route('services.show', 'seo-optimization') }}">SEO agencies</a></li>
                        <li><a href="{{ route('services.show', 'seo-optimization') }}">Content Marketing</a></li>
                        <li><a href="{{ route('services.show', 'seo-optimization') }}">B2B SEO Agency</a></li>
                        <li><a href="{{ route('services.show', 'seo-optimization') }}">Content Creation Agency</a></li>
                        <li><a href="{{ route('services.show', 'seo-optimization') }}">Content Strategy Agency</a></li>
                        <li><a href="{{ route('services.show', 'seo-optimization') }}">Global SEO Agency</a></li>
                        <li><a href="{{ route('services.show', 'seo-optimization') }}">Enterprise SEO</a></li>
                        <li><a href="{{ route('services.show', 'seo-optimization') }}">Inbound Marketing Agency</a></li>
                        <li><a href="{{ route('services.show', 'seo-optimization') }}">B2B Content Marketing</a></li>
                    </ul>
                </div>

                {{-- Column 3: Resources & Consulting --}}
                <div class="directory-col">
                    <h4 class="directory-col-title">Resources</h4>
                    <ul class="directory-link-list">
                        <li><a href="{{ route('services.show', 'web-development') }}">Business Phone Services</a></li>
                        <li><a href="{{ route('services.show', 'web-development') }}">Ecommerce Website Builders</a></li>
                        <li><a href="{{ route('services.show', 'digital-marketing') }}">Email Marketing Services</a></li>
                        <li><a href="{{ route('services.show', 'web-development') }}">Web Hosting Providers</a></li>
                        <li><a href="{{ route('services.show', 'seo-optimization') }}">SEO Tools</a></li>
                        <li><a href="{{ route('services.show', 'digital-marketing') }}">Best Marketing Agencies</a></li>
                        <li><a href="{{ route('services.show', 'digital-marketing') }}">AI in Digital Marketing</a></li>
                    </ul>

                    <h4 class="directory-col-title directory-subhead">Consulting & DIY</h4>
                </div>

                {{-- Column 4: Marketing TIPS & Guides --}}
                <div class="directory-col">
                    <h4 class="directory-col-title">Marketing TIPS & Guides</h4>
                    <ul class="directory-link-list">
                        <li><a href="{{ route('blog.index') }}">Digital Marketing Trends</a></li>
                        <li><a href="{{ route('blog.index') }}">Best Marketing Campaigns</a></li>
                        <li><a href="{{ route('blog.index') }}">SEO Techniques</a></li>
                        <li><a href="{{ route('blog.index') }}">Influencer Marketing</a></li>
                        <li><a href="{{ route('blog.index') }}">Alternate Ad Networks</a></li>
                        <li><a href="{{ route('blog.index') }}">Link-Building With Content</a></li>
                        <li><a href="{{ route('blog.index') }}">YouTube SEO</a></li>
                        <li><a href="{{ route('blog.index') }}">Step-by-step Content Audit</a></li>
                        <li><a href="{{ route('blog.index') }}">Build a Marketing Funnel</a></li>
                    </ul>
                </div>
            </div>
