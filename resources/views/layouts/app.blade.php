                ...
                <div class="footer-col footer-col-brand">
                    ...
                    <div class="footer-social-circles">
                        @if(!empty($site['facebook']))
                            <a href="{{ $site['facebook'] }}" target="_blank" rel="noopener" aria-label="Facebook" class="social-circle-btn">
                        ...
                        @if(!empty($site['linkedin']))
                            <a href="{{ $site['linkedin'] }}" target="_blank" rel="noopener" aria-label="LinkedIn" class="social-circle-btn">
                        ...
                        @endif
                        <a href="https://youtube.com" target="_blank" rel="noopener" aria-label="YouTube" class="social-circle-btn">
                        ...
                        <a href="https://instagram.com" target="_blank" rel="noopener" aria-label="Instagram" class="social-circle-btn">
