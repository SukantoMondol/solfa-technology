...
Route::get('/projects/{project:slug}', [PageController::class, 'showProject'])->name('projects.show');
...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware('auth')->group(function () {
        ...
        Route::get('/job-applications/{application}/view-cv', [Admin\JobApplicationController::class, 'viewCv'])->name('job-applications.view-cv');
